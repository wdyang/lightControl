//https://github.com/ranma1988/ESP8266-json-server/blob/master/ESP8266-json-server.ino
...
void setup(void) {
  ...
  Serial.begin(115200);
  delay(10);
  sprintf_P(NAME, PSTR("light%02d"), ID);
...
//  g_udp.begin(g_port);
  ...
  server.on("/led_status", reportLED);
